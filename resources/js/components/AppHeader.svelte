...
import Globe from 'lucide-svelte/icons/globe';
    ...
    import LogoutConfirmDialog from '@/components/LogoutConfirmDialog.svelte';
    import {
        Avatar,
        AvatarFallback,
        AvatarImage,
                                    ...
                                    <TooltipTrigger>
                                        {#snippet child({ props })}
                                            <a
                                                ...
                                                rel="noopener noreferrer"
                                                {...props}
                                                class="inline-flex items-center justify-center rounded-full text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground h-9 w-9 group cursor-pointer"
                                            >
                                                <span class="sr-only"
                                                    >{item.title}</span
                                                >
...
<LogoutConfirmDialog bind:open={showLogoutConfirm} />
